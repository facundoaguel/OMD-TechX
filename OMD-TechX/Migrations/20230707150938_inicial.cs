        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    miércoles = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    jueves = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    viernes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    sábado = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adopcion_comentarios = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Hallazgo_comentarios = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Hallazgo_Foto = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    primerInicio = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PerroAtenciones",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PerroId = table.Column<int>(type: "int", nullable: false),
                    perro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Atencion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AtencionId = table.Column<int>(type: "int", nullable: false),
                    Fecha = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerroAtenciones", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerroAtenciones_PerroId",
