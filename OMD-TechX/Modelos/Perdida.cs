...
{
    public class Perdida : Publicacion
    {
        public string comentarios { get; set; }
        public byte[]? Foto { get; set; }

        [JsonConstructor]
        public Perdida(string nombre, DateTime fechaN, string raza, string tamanio, string sexo, string color, string usuarioId, string comentarios) : base(nombre, fechaN, raza, tamanio, sexo, color, usuarioId)
        {
